...
outpath = '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/'
...
target_FieldID = ['53-0.0', '190-0.0',
                  ...
                  '40000-0.0',
                  '130836-0.0', '130837-0.0', '131036-0.0', '131037-0.0', '42020-0.0', '42021-0.0']
...
rm_idx3 = mydf.index[mydf['BL2AD_yrs'] > 15]
# remove participants diagnosed Dementia before the baseline visit
rm_idx4 = mydf.index[mydf['BL2AD_yrs'] <=0]
...
mydf.to_csv(outpath + 'S0_AD_Target.csv', index = False)
